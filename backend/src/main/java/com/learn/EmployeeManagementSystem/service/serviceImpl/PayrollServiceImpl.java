...
public class PayrollServiceImpl implements PayrollService {
    ...
    public PayrollResponse createPayroll(
        ...
        BigDecimal basicSalary = payrollRequest.getBasicSalary() != null ? payrollRequest.getBasicSalary() : BigDecimal.ZERO;
        BigDecimal bonus = payrollRequest.getBonus() != null ? payrollRequest.getBonus() : BigDecimal.ZERO;
        BigDecimal deduction = payrollRequest.getDeduction() != null ? payrollRequest.getDeduction() : BigDecimal.ZERO;
        ...
        BigDecimal netSalary = basicSalary.add(bonus).subtract(deduction);
